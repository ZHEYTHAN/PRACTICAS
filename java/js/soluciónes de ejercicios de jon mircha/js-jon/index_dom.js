...
darktheme(".dark-theme-btn", "dark-mode"); //Se saco del DOMContentLoaded ya que en su js se va a usar en la funcion otro DOMContentLoaded y es para que no genere conflicto.